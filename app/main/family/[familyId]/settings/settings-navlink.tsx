...
export default function SettingsNavLink() {
    ...
    return (
        <div className="m-1 flex min-w-full space-x-8 overflow-x-auto whitespace-nowrap rounded-sm bg-slate-200 p-3 py-2 dark:bg-slate-800">
            <LinkTab href="general">一般</LinkTab>
            <LinkTab href="subscription">プラン</LinkTab>
